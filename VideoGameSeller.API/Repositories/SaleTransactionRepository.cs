...
{
    public class SaleTransactionRepository : Repository<SaleTransactionModel, SaleForm>
    {
        public SaleTransactionRepository(Connection connection) : base(connection)
        {
            SetVerificationField("UserId");
        }
        ...
        protected override Mapper<SaleTransactionModel> Mapper => new SaleTransactionMapper();
    }
}
